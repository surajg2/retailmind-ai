    ...
    <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-5 shadow-xl backdrop-blur-md">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-slate-200">Data Integrity & Quality Score</h3>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-950/60 rounded-xl p-3.5 border border-slate-800/80">
          <div className="text-[11px] font-medium text-slate-400 mb-1 flex items-center justify-between">
            ...
            <span className="font-bold text-slate-200">{report.quality_score}%</span>
          </div>
        ...
        <div className="bg-slate-950/60 rounded-xl p-3.5 border border-slate-800/80">
          ...
          <span className="text-[10px] text-slate-500 mt-0.5 block">Unrecorded dates in date range</span>
        </div>
